...
| 版本 | 主题 | 状态 | 主要交付 |
|---|---|---|---|
| v10.0 | PocketBase 后端落地 | ✅ 规划完成 | API 客户端抽象、双向同步、迁移工具 |
| v10.1 | i18n 国际化 (中/英) | 🔄 进行中 | react-i18next 接入、5 国语料 |
| v11.0 | AI 能力层 | ⏳ 规划中 | AI 导购/辩论/摘要/推荐引擎 |
| v12.0 | 性能与体验 | ⏳ 待启动 | SSG、骨架屏、虚拟滚动 |
| v13.0 | 创作者经济 | ⏳ 待启动 | 打赏、付费辩论、分销、税务台账 |
| v14.0 | 测试与质量 | ⏳ 待启动 | Vitest 80% + Playwright E2E + 性能预算 |
