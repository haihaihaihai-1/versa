...
import {
  ...
  StickyNote, Video, Palette, LayoutDashboard, Inbox, Vote, Hash, Heart, Ticket, Target, Edit3, Trophy, Wallet, HeartPulse, Plane, TrendingUp, GraduationCap, ChefHat, Music,   UserCheck, PawPrint, Brain, Camera, Sigma, Car, Sprout,
                  ...
                  <div className="absolute right-0 mt-2 w-64 rounded-xl border border-ink-200 dark:border-ink-800 bg-white dark:bg-ink-900 shadow-xl overflow-hidden z-50">
                    ...
                    <div className="py-1">
                      {[
                        ...
                        { to: '/tools/invest', label: '投资中心', icon: TrendingUp },
                        { to: '/tools/learn', label: '学习中心', icon: GraduationCap },
                        { to: '/tools/food', label: '美食中心', icon: ChefHat },
                        { to: '/tools/music', label: '音乐正念', icon: Music },
                        { to: '/tools/family', label: '家庭中心', icon: UserCheck },
                        { to: '/tools/pets', label: '宠物中心', icon: PawPrint },
                        { to: '/tools/ai', label: 'AI 实验场', icon: Brain },
                        { to: '/tools/photo', label: '摄影中心', icon: Camera },
                        { to: '/tools/math', label: '数学中心', icon: Sigma },
                        { to: '/tools/car', label: '车生活', icon: Car },
                        { to: '/tools/astro', label: '占星中心', icon: Sparkles },
                        { to: '/tools/garden', label: '园艺中心', icon: Sprout },
                      ].map((item) => (
                        <Link
                          key={item.to}
                          to={item.to}
